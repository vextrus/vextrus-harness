 ...
 *
 * Written as `.mjs` next to the runner it describes: the drop-in runners belong
 * to no tsconfig project, and a `.ts` test would have to import across that line.
 */
import { describe, expect, test } from 'vitest';

import { announcedStage, ranStage, stageLineIndex, stageMarker } from '../stage.mjs';
